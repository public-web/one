...
/**
* @see \App\Http\Controllers\Api\BancoProyectoController::downloadTemplate
...
const BancoProyectoController = { stats, exportMethod, downloadTemplate, importMethod, restore, forceDelete, index, store, show, update, destroy, export: exportMethod, import: importMethod }
